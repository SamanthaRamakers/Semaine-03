...
function additionOnClick() {
  document.getElementById('').addEventListener('click', function addition() {
    ...
    let PremierNumero = parseInt(document.getElementById('first-number').value);
    let NombreDeux = document.getElementById('second-number').value;
    console.log(PremierNumero + NombreDeux);
  });
}
